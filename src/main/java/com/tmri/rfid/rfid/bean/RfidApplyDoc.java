...
public class RfidApplyDoc{
	...
	public RfidApplyDoc(String xh,String sqbh,String lx,byte[] wd,String zt){
		this.xh=xh;
		this.sqbh=sqbh;
		this.lx=lx;
		this.wd=wd;
	...
	public RfidApplyDoc(String xh){
		this.xh=xh;
	}
	public RfidApplyDoc(String sqbh,String lx){
		this.sqbh=sqbh;
		this.lx=lx;
	}
	public String getXh(){
