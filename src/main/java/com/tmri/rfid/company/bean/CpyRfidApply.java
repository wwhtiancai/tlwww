...
public class CpyRfidApply{
	...
	public void setXsztp(String xsztp){
		this.xsztp=xsztp;
	}
	public String getBsktp(){
		return bsktp;
	}
	public void setBsktp(String bsktp){
		this.bsktp=bsktp;
	}
	public String getQctp(){
		return qctp;
	}
	public void setQctp(String qctp){
		this.qctp=qctp;
	}
