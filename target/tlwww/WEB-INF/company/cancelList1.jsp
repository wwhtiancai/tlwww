...
<head>
    ...
    <script type="text/javascript">
        ...
        function query_cmd(){
            ...
            $("#myform").attr("action","flow.htm?method=queryPageInfo");
            closes();
            $("#myform").submit();
        }
        function detail(pk){
                        ...
                        <table border="0" cellspacing="1" cellpadding="0" class="query">
                            ...
                            <tr>
                                ...
                                <td class="body"><select id="clzt" name="clzt" class="select form-control">
                                    <option value="1">1:可退办</option>
                                    <option value="2">2:已退办（已无效）</option>
                                </select></td>
                                <td class="command"><button type="button" class="btn btn-info" onClick="query_cmd()">查询</button><td>
                            </tr>
                        </table>
                    </form>
                </div>
                    ...
                    <div class="mb20">
                        <table class="table table-bordered table-hover mb0">
                            ...
                            <c:forEach items="${queryList}" var="current">
                                <tr >
                                <td><c:out value="${current.tid}"/></td>
                                <td><c:out value="${current.hpzl}"/></td>
