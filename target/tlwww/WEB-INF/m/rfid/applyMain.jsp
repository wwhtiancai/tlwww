...
function query(){
	...
	$("#myform").attr("action","eri.htm?method=listApply");
	closes();
	$("#myform").submit();
}
...
<div class="container-fluid">
	<div class="row bg-primary top">
		<div class="col-xs-9"><a href="index.htm" class="fontbold white" style="text-decoration:none;"><i class="icon-credit-card mr5"></i>标签卡受理</a></div>
		...
		<div class="row mt20">
			<div class="col-xs-12">
			  <div class="form-group">
			    <label for="name" class="font14">选择汽车电子标识卡：</label>
			  </div>
			</div>
		</div>
		<div class="row mt10">
			<div class="col-xs-12 tc">
				<button type="button" class="btn btn-primary btn-lg" onClick="openquery()">输入标识卡卡号</button>
			</div>
		</div>
		<div class="row mt5">
			<div class="col-xs-12">
			  <div class="tc">
	       	<div class="font12 mt10 tc" style="line-height:1.2;">提示：卡号位于汽车电子标识卡右上方。</div>
			  </div>
			</div>
		</div>
	...
	<div class="row mt20" id="querypanel" style="display:none;">
		<div class="col-xs-12">
		  <div class="form-group">
		  ...
		  <div class="tc"><button type="button" class="btn btn-primary btn-lg" onClick="query()">确定</button><button type="button" class="btn btn-warning btn-lg ml20" onClick="back()">返回</button></div>
		</div>
	</div>
</div>
